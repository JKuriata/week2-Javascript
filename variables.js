...
console.log(
  `You have added £ ${payment} to your balance of £ ${balance}. This has resulted in the new balance of £ ${newBalance}.`
);
console.log("------");
...
const d1 = new Date(2024, 8, 5);
const daysSinceBirth = Math.floor((d1 - d0) / (1000 * 60 * 60 * 24)); // Convert milliseconds to days
console.log(`${daysSinceBirth} days since birth`);
console.log("-----------");
